...
class English {
    static void addTranslations(MKEnglishProvider english) {
        ...
        english.add(TranslationKeys.CREAKING_CORE_JEI_INFO, "Use a creaking core on a Pale Oak Log to turn it into a Creaking Heart. Creaking Hearts created this way do not drop experience orbs when broken.");
