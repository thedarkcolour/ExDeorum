...
public class ExDeorumJeiPlugin implements IModPlugin {
    public static final ResourceLocation ENH_JEI_TEXTURE = new ResourceLocation(ExDeorum.ID, "textures/gui/jei/enr_jei.png");
    ...
    public static final RecipeType<?> BARREL_MIXING = RecipeType.create(ExDeorum.ID, "barrel_compost", Object.class);
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        ...
        IDrawable arrow = helper.createDrawable(ExDeorumJeiPlugin.ENH_JEI_TEXTURE, 0, 18, 22, 15);
