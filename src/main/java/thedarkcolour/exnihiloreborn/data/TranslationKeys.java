...
public class TranslationKeys {
    public static final String MAIN_CREATIVE_TAB = "itemGroup." + ExNihiloReborn.ID + ".main";
    public static final String VOID_WORLD_TYPE = "generator." + ExNihiloReborn.ID + ".void_world";

    // Advancements
    public static final String ROOT_ADVANCEMENT_TITLE = "advancements." + ExNihiloReborn.ID + ".core.root.title";
    public static final String ROOT_ADVANCEMENT_DESCRIPTION = "advancements." + ExNihiloReborn.ID + ".core.root.description";
    public static final String CROOK_ADVANCEMENT_TITLE = "advancements." + ExNihiloReborn.ID + ".core.crook.title";
    public static final String CROOK_ADVANCEMENT_DESCRIPTION = "advancements." + ExNihiloReborn.ID + ".core.crook.description";
    public static final String BARREL_ADVANCEMENT_TITLE = "advancements." + ExNihiloReborn.ID + ".core.barrel.title";
    public static final String BARREL_ADVANCEMENT_DESCRIPTION = "advancements." + ExNihiloReborn.ID + ".core.barrel.description";
    public static final String SILK_WORM_ADVANCEMENT_TITLE = "advancements." + ExNihiloReborn.ID + ".core.silk_worm.title";
    public static final String SILK_WORM_ADVANCEMENT_DESCRIPTION = "advancements." + ExNihiloReborn.ID + ".core.silk_worm.description";
